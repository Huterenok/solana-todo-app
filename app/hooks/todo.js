...
export function useTodo() {
	...
	const deleteTodo = async (todoPda, todoIdx) => {
		if (program && publicKey) {
				try {
						setTransactionPending(true);
						setLoading(true);
    ...
    return { initialized, initializeUser, loading, transactionPending, completedTodos, incompleteTodos, markTodo, deleteTodo, addTodo, input, setInput, handleChange }
}
