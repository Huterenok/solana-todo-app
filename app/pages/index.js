...
const Home = () => {
    const { initialized, initializeUser, loading, transactionPending, completedTodos, incompleteTodos, addTodo, markTodo, deleteTodo, input,  handleChange } = useTodo()
        ...
        <div className={styles.container}>
            ...
            <div className={styles.mainContainer}>
                <Loading loading={loading}>
                    ...
                    <TodoSection title="Completed" todos={completedTodos} action={deleteTodo} />
                </Loading>
            </div>
        </div>
    )
